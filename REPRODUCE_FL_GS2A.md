...
2. For SGD with B=50, among lr={0.01, 0.005, 0.046, 0.032}, lr=0.1 converge to 72% test acc quickest (within 30 rounds), but smaller lrs reach a slightly higher maximum test acc. One can choose to show 
