...
`tf_cnn`   |FedSGD|non-iid |30000  |    hrs   | A       | 0.1  |1  |∞  | 0.1       |       | SGD   | `t1` transform | run on A
`tf_cnn`   |FedSGD|non-iid |20000  |19.9hrs   | A       | 0.1  |1  |∞  | 0.05      |       | SGD   | `t1` transform | done
`tf_cnn`   |FedSGD|non-iid |30000  |    hrs   | A       | 0.1  |1  |∞  | 0.05      |       | SGD   | `t1` transform | run on A
...
`tf_cnn`   |FedAvg|non-iid |10000  |    hrs   | A       | 0.1  |5  |50 | 0.01      |       | SGD   | `t1` transform | 
