...
`tf_cnn`   |FedAvg|non-iid |20000  |19.6hrs   | A       | 0.1  |1  |100| 0.2       |       | SGD   | `t1` transform | done
`tf_cnn`   |FedAvg|non-iid |20000  |19.6hrs   | A       | 0.1  |1  |100| 0.1       |       | SGD   | `t1` transform | done
`tf_cnn`   |FedAvg|non-iid |20000  |21.2hrs   | A       | 0.1  |1  |100| 0.05      |       | SGD   | `t1` transform | done, `selected`
`tf_cnn`   |FedAvg|non-iid |20000  |21.2hrs   | A       | 0.1  |1  |100| 0.02      |       | SGD   | `t1` transform | done
`tf_cnn`   |FedAvg|non-iid |20000  |21.2hrs   | A       | 0.1  |1  |100| 0.01      |       | SGD   | `t1` transform | done
