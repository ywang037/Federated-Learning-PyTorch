...
The citation to which they referred in the paper cannot be found as of now. However, TensorFlow tutorial on implementing a simple CNN can still be found [here](https://www.tensorflow.org/tutorials/images/cnn?hl=zh-cn). Alternatively, one can also refer to this webpage for the information and architecture of the example CNN.  
